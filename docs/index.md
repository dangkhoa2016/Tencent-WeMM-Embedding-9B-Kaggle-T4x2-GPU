...
This documentation set is the long-form manual for **Tencent WeMM-Embedding-9B on Kaggle T4×2**. The root README is the project landing page; the documents below explain setup, architecture, interfaces, evaluation, reproducibility, limits, and maintenance in more depth.
