...
This repository contains integration code and documentation. It does **not** relicense the upstream Tencent model or the public data used by the demo.
...
The runtime expects a complete local WeMM model directory containing the custom model code, processor/tokenizer configuration, and safetensors weights.
...
- Tencent WeMM model weights and upstream model code;
