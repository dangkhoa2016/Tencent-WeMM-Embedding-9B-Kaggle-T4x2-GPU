# Tencent WeMM-Embedding-9B on Kaggle T4×2
...
> **v1.0.0** is the first public stable release for community use, review, and reproducibility testing.

> This is an independent engineering project around the upstream Tencent model and is **not an official Tencent release**.
...
3. loading WeMM-Embedding-9B across both T4 GPUs;
...
```mermaid
flowchart LR
    A["Text / Image / Image + Text"] --> B["WeMM-Embedding-9B"]
...
| Qdrant | 1.19.0 |
| Runtime source pinned by public notebook | `d04bcd3e601b449b67d09ff1132cab965619d858` |
...
The MIT license applies to source code in this repository. Tencent WeMM model weights, datasets, Kaggle services, Qdrant, and other third-party dependencies remain subject to their own upstream licenses and terms.
