# Tencent WeMM-Embedding-9B trên Kaggle T4×2
...
> **v1.0.0** là bản stable công khai đầu tiên dành cho cộng đồng sử dụng, review và kiểm tra khả năng tái lập.

> Đây là dự án kỹ thuật độc lập xây dựng quanh model Tencent upstream, **không phải release chính thức của Tencent**.
...
3. load WeMM-Embedding-9B lên cả hai GPU T4;
...
| Qdrant | 1.19.0 |
| Runtime source được public notebook pin | `d04bcd3e601b449b67d09ff1132cab965619d858` |
...
MIT License áp dụng cho source code của repository này. Model weights Tencent WeMM, dataset, dịch vụ Kaggle, Qdrant và dependency bên thứ ba tiếp tục tuân theo license và điều khoản riêng của upstream.
